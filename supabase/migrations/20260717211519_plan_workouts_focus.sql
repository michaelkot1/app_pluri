-- plan_workouts.focus (M3-20): nullable session-focus code + Manage Plan RPC
-- so regeneration flushes/restores focus (SPEC §14 #46). No backfill —
-- legacy rows stay NULL; the next regeneration writes codes.
--
-- Applied remotely as version 20260717211519. Local file restores the same
-- shape for fresh `supabase db reset` / CI.
